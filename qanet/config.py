...
def add_qanet_config(cfg):
    ...
    cfg.MODEL.QANET.QA_BRANCH.GNGROUPS = 32
    cfg.MODEL.QANET.QA_BRANCH.MLPRATIO = 4
    cfg.MODEL.QANET.QA_BRANCH.MSCA_NUMS = 3
    cfg.MODEL.QANET.QA_BRANCH.INIT_CONVS = 3
    cfg.MODEL.QANET.QA_BRANCH.MASK_CONVS = 3
    ...
    cfg.MODEL.MATCHER.SCORE_TYPE = 'dice'
