...
def add_qanet_config(cfg):
    ...
    cfg.MODEL.MATCHER.DYNAMIC_K = True
    cfg.MODEL.MATCHER.START_K = 10

    # [CRITERION]
    cfg.MODEL.CRITERION = CN()
    cfg.MODEL.CRITERION.ITEMS = ("masks", "edges", "obj", "masks_aux")
    cfg.MODEL.CRITERION.LOSS_MASKS_DICE_WEIGHT = 1.0
    cfg.MODEL.CRITERION.LOSS_MASKS_BCE_WEIGHT = 1.0
    cfg.MODEL.CRITERION.LOSS_EDGES_DICE_WEIGHT = 0.3
    cfg.MODEL.CRITERION.LOSS_EDGES_BCE_WEIGHT = 0.3
    cfg.MODEL.CRITERION.LOSS_OBJ_WEIGHT = 1.0
    cfg.MODEL.CRITERION.LOSS_MASKS_AUX_DICE_WEIGHT = 0.5
