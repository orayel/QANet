...
from detectron2.utils.events import get_event_storage, CommonMetricPrinter, JSONWriter, TensorboardXWriter
...
def CustomWriter(output_dir: str, max_iter: Optional[int] = None):

    PathManager.mkdirs(output_dir)
    return [
        # It may not always print what you want to see, since it prints "common" metrics only.
        CustomCommonMetricPrinter(max_iter),
